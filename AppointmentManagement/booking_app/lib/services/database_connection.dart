...
class DatabaseConnection {
  ...
  static Future<void> loginWithGoogleUser({
    required String email,
    required String name,
    required String providerId,
  }) async {
    var result = await conn.query(
      'SELECT * FROM mtas."tblLoginUser" WHERE "Provider_ID"=@pid',
      substitutionValues: {'pid': providerId},
    );
    ...
    if (result.isEmpty) {
      ...
      ("Email","Name","Provider","Provider_ID","Active","Last_Login")
      VALUES (@email,@name,'google',@pid,TRUE,NOW())
    ''', substitutionValues: {
        'email': email,
        'name': name,
        'pid': providerId,
